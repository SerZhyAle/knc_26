...
Begin VB.Form Form1 
   ...
   Begin VB.Image Image10 
      Height          =   780
      Left            =   3360
      Picture         =   "Form1.frx":0A8A
      Stretch         =   -1  'True
      ToolTipText     =   "Кушнарев"
      Top             =   3600
      Visible         =   0   'False
      Width           =   780
   End
   ...
   Begin VB.Image Image6 
      Height          =   780
      Left            =   0
      Picture         =   "Form1.frx":4C19
      Stretch         =   -1  'True
      ToolTipText     =   "Пост президента."
      Top             =   4440
      Visible         =   0   'False
      Width           =   780
   End
   ...
   Begin VB.Image Image4 
      Height          =   780
      Left            =   0
      Picture         =   "Form1.frx":680C
      Stretch         =   -1  'True
      ToolTipText     =   "Янукович"
      Top             =   2760
      Visible         =   0   'False
      Width           =   780
   End
   ...
   Begin VB.Image Image2 
      Height          =   780
      Left            =   0
      Picture         =   "Form1.frx":86BD
      Stretch         =   -1  'True
      ToolTipText     =   "Страница закона Украины"
      Top             =   1080
      Visible         =   0   'False
      Width           =   780
   End
   Begin VB.Image Image1 
      Height          =   780
      Left            =   0
      Picture         =   "Form1.frx":969B
      Stretch         =   -1  'True
      ToolTipText     =   "Пустое место."
      Top             =   240
      Visible         =   0   'False
      Width           =   780
   End
...
Private Sub lpl(x1 As Integer, y1 As Integer, x2 As Integer, y2 As Integer, xy As Integer, atx As Integer, aty As Integer)
 ...
 'If xy > 0 Then
  ...
  Case 0
  Images(im) = Image1
  Images(im).ToolTipText = "Пустое место"
  Case 1
  Images(im) = Image2
  Images(im).ToolTipText = "Страница закона"
  Case 2
  Images(im) = Image3
  Images(im).ToolTipText = "Ющенко"
  Case 3
  Images(im) = Image4
  Images(im).ToolTipText = "Янукович"
  Case 4
  zzz = 1
  Do While zzz <= BL_end
   If BL(zzz, 1) = atx And BL(zzz, 2) = aty Then
    If BL(zzz, 4) = 1 Then Images(im) = Image5: Images(im).ToolTipText = "Кучма":
    If BL(zzz, 4) = 2 Then Images(im) = Image7: Images(im).ToolTipText = "Путин":
    If BL(zzz, 4) = 3 Then Images(im) = Image8: Images(im).ToolTipText = "Кивалов":
    If BL(zzz, 4) = 4 Then Images(im) = Image9: Images(im).ToolTipText = "Тигипко":
    If BL(zzz, 4) = 5 Then Images(im) = Image10: Images(im).ToolTipText = "Кушнарев":
   End If
   zzz = zzz + 1
  Loop
    Case 5
  Images(im) = Image6
  Images(im).ToolTipText = "Президентское кресло"
  End Select
...
If lost = 1 Then
If skin = 1 Then
 sms = MsgBox("ИГРА ПРОИГРАНА!", vbOKOnly, Trim(Images(BL(z, 2) + (BL(z, 1) - 1) * ww).ToolTipText) + " УБИЛ вас!")
 Else
...
If lost = 1 Then
If skin = 1 Then
 sms = MsgBox("ИГРА ПРОИГРАНА!", vbOKOnly, Trim(Image4.ToolTipText) + " УБИЛ вас!")
 Else
...
If skin = 1 Then
   k = k + 1
   im = zy + (zx - 1) * ww
   If k = 1 Then Images(im) = Image5: BL(z, 4) = 1
   If k = 2 Then Images(im) = Image7: BL(z, 4) = 2
   If k = 3 Then Images(im) = Image8: BL(z, 4) = 3:
   If k = 4 Then Images(im) = Image9: BL(z, 4) = 4:
   If k = 5 Then Images(im) = Image10: BL(z, 4) = 5: k = 0
   End If
Next z
'Exit
MiR = 0
...
If skin = 1 Then skin = 0 Else skin = 1
'MsgBox skin
zzz = 1
...
For z = 0 To ww - 1
 For zz = 1 To ww
  im = zz + z * ww
 ' Open "c:\1.1" For Append As 1
 ' Print #1, Trim$(im)
 ' Close 1
  Load Images(im)
  Images(im).Left = sh.Left + (z) * x
  Images(im).Top = sh.Top + (zz - 1) * y
  Images(im).Width = x
  Images(im).Height = y
  Select Case M(z + 1, zz)
  Case 0
  Images(im) = Image1
  Images(im).ToolTipText = "Пустое место"
  Case 1
...
For z = 1 To BL_end
   k = k + 1
   im = BL(z, 2) + (BL(z, 1) - 1) * ww
   If k = 1 Then Images(im) = Image5: Images(im).ToolTipText = "Кучма": BL(z, 4) = 1
   If k = 2 Then Images(im) = Image7: Images(im).ToolTipText = "Путин": BL(z, 4) = 2
   If k = 3 Then Images(im) = Image8: Images(im).ToolTipText = "Кивалов": BL(z, 4) = 3:
   If k = 4 Then Images(im) = Image9: Images(im).ToolTipText = "Тигипко": BL(z, 4) = 4:
   If k = 5 Then Images(im) = Image10: Images(im).ToolTipText = "Кушнарев": BL(z, 4) = 5: k = 0
Next z
Label6(0).Caption = "Электорат Украины. По нему двигаются Ющенко, Янукович и его помощники."
Label6(1).Caption = "Страницы закона Украины. Закон нужно обходить или даже изменять, если за ним пост президента или пусто."
Label6(2).Caption = "Ющенко. Вы им управляете стрелочками, - вы хотите достичь президетского поста."
Label6(3).Caption = "Янукович. Он бессмертен. Всегда идет к Ющенко и, если достигнет его, обязательно убьет."
Label6(4).Caption = "Помощники Януковича. Они двигаются беспорядочно, но если окажутся возле Ющенко, - могут отравить. Их можно убить с помощью страницы закона."
Label6(5).Caption = "Кресло президента Украины. К нему и стремится Ющенко."
zzz = 0
'Call Form_Activate
End Sub
