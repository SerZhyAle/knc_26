...
The current MVP version is `26.05.31.2223`. It is implemented with TypeScript, Vite, HTML5 Canvas, Vitest, ESLint, a static service worker, and GitHub Pages deployment.
